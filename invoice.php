...
<body data-gr-c-s-loaded="true" cz-shortcut-listen="true" style="width: 300px;">
	...
	<div>
		<table style="width:100%;font-size:12px;font-weight:600;border-collapse:collapse;">
			...
			<?php $count++; $sp_id++; $total_qty += $row1['quantity']; $given_discount += (($row1['actual_price']*$row1['quantity'])-$row1['price']); } ?>
		    </tbody>
		</table>
		<hr style="margin-top:9px;margin-bottom:9px;border-color:#8c8c8c;">
		<table style="width:100%;font-size:12px;font-weight:600;border-collapse:collapse;">
		    ...
		    <tr>
		        <td style="text-align:right;padding:0px 7px;">Taxable amount : </td>
		        <td style="text-align:right;padding:0px 7px;"><?= number_format($value_after_discount,2) ?></td>
		    </tr>
		    <?php    
