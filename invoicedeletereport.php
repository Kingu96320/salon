...
if (isset($_POST['reset'])) {
    echo '<meta http-equiv="refresh" content="0; url=invoicedeletereport.php" />';
    die();
}
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="panel">
                    <div class="panel-heading heading-with-btn">
                        <h4 class="pull-left">Invoice Delete Reports</h4>
...
<?php if (isset($_POST['submit'])) { ?>
                                            ...
                                            <table id="table" class="table grid table-bordered no-margin">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $sql1 = "SELECT DISTINCT(i.id) as invid, i.*,c.name,c.cont from `invoice_" . $branch_id . "` i LEFT JOIN `client` c on c.id =i.client " . $sp_query . " " . $ser_query . " where i.active=1 and i.branch_id='" . $branch_id . "' " . $submit . " order by i.id desc";
